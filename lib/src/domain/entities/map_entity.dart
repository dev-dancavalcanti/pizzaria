class MapDistanceDurationModel {
  List<String>? destinationAddresses;
  List<String>? originAddresses;
  List<Rows>? rows;

  MapDistanceDurationModel(
      {this.destinationAddresses, this.originAddresses, this.rows});

  MapDistanceDurationModel.fromJson(Map<String, dynamic> json) {
...
class Elements {
  ...
  Elements({this.distance, this.duration});
